...
// const p = (num1, num2) => {return num1 * num2;};
...
const last = (arr, callback) => { return callback(arr[arr.length - 1]);};
...
*/
 ...
 uniq(names, uniqArr => console.log(`The new names array with no duplacates ${uniqArr}`))
...
each(names, (item, index) => console.log(`The item at indes ${index} is ${item}`))
